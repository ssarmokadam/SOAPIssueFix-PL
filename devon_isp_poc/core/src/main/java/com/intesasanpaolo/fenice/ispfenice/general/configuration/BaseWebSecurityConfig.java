...
import com.intesasanpaolo.fenice.ispfenice.general.common.impl.security.ApplicationAuthenticationProvider;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    String[] unsecuredResources = new String[] { "/login", "/security/**", "/services/**", "/services/rest/logout" };
