...
CREATE TABLE INTERVISTA(
  ...
  modificationCounter INTEGER NOT NULL,
  IDINTERVISTA BIGINT(10),
  NOME VARCHAR(2000),
  COGNOME VARCHAR(2000),
  DATANASCITA DATE,
  NDG VARCHAR(100),
  CODABI VARCHAR(100),
 ...
 CREATE TABLE OFFERTA(
  ...
  CONSTRAINT FK_INTERVISTA2OFFERTA FOREIGN KEY (IDINTERVISTA) REFERENCES INTERVISTA(IDINTERVISTA),
  KEY (id)
  );
  ...
  CONSTRAINT FK_OFFERTA2PREVENTIVO FOREIGN KEY (IDOFFERTA) REFERENCES OFFERTA(IDOFFERTA),
  KEY (id)
 );
