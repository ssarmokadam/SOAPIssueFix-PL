...
import com.intesasanpaolo.fenice.ispfenice.general.service.impl.soap.GeneralSoapServiceImpl;
...
public class ServiceConfiguration extends WsConfigurerAdapter {
  ...
  // BEGIN POC SOAP
  @Bean
  public Endpoint generalSoapManagement() {

    EndpointImpl endpoint = new EndpointImpl(springBus(), new GeneralSoapServiceImpl());
    endpoint.publish("/GeneralSoapService");
    return endpoint;
  }
  // END POC SOAP
